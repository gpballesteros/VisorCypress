describe('Test module users', () => {
    ...
    it('Modify User', () => {
        ...
        cy.get('[form="modify-user-data-form"]').click()
        cy.get('modify-user.ng-star-inserted > :nth-child(5) > :nth-child(2)').click()
    })

    it('Change password', () => {
        cy.contains('Testing').click()
        cy.get(':nth-child(4) > .ng-star-inserted').click()
        cy.get('#password-input').type('0987654321')
        cy.get('#password-input2').type('0987654321')
        cy.get('.ng-star-inserted > [type="submit"]').click()
        cy.get('.views > :nth-child(1)').click()
    })
